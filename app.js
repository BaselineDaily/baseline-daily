...
ReactDOM.createRoot(document.getElementById('root')).render(/*#__PURE__*/React.createElement(Baseline, null));

} catch (e) {
  if (window.__showErr) window.__showErr('APP ERROR: ' + (e.message || e) + '\n' + (e.stack || '').split('\n').slice(0,5).join('\n'));
